...
from engine.trainer import do_train, do_train_with_center,do_train_pcb, do_train_pcb_with_center
...
# import cv2
# I=cv2.imread('/share/nif/tiger/reid/train/000327.jpg')
def train(cfg):
    # prepare dataset
