...
_C.MODEL.COSINE_LOSS_SCALE = 30.0
_C.MODEL.COSINE_LOSS_MARGIN = 0.1
# If train with label smooth, options: 'on', 'off'
_C.MODEL.IF_LABELSMOOTH = 'on'

# barh hard for triplet loss
_C.MODEL.BATCH_HARD = 'yes'
_C.MODEL.COSINE_LOSS_TYPE = 'CosFace'
_C.MODEL.PCB_WITH_GLOBAL = 'no'
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
# Margin of Margin Sample Mining loss
_C.SOLVER.MSML_MARGIN = 0.1
...
_C.SOLVER.MSML_LOSS_WEIGHT = 0.1
