...
class MSMT17(BaseImageDataset):
    ...
    def __init__(self,root='/home/haoluo/data', verbose=True, **kwargs):
        ...
        self.list_train_path = osp.join(self.dataset_dir, 'MSMT17_V2/list_train.csv')
        self.list_val_path = osp.join(self.dataset_dir, 'MSMT17_V2/list_val.csv')
        self.list_query_path = osp.join(self.dataset_dir, 'MSMT17_V2/list_query.csv')
        self.list_gallery_path = osp.join(self.dataset_dir, 'MSMT17_V2/list_gallery.csv')
